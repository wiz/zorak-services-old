 ...
 *
 *  $Id: nickserv.h,v 1.2 2002/10/02 02:56:15 wiz Exp $
 */

u_short	ns_register	(user_t *, char *);
u_short	ns_identify	(user_t *, char *);
u_short	ns_drop		(user_t *, char *);
u_short	ns_info		(user_t *, char *);
u_short	ns_list		(user_t *, char *);
